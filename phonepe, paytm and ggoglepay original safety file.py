...
for i in range(1):
    if c==1:
          ...
          ca=input('Enter the bank account number: ')
          at=input('Enter the ATM card number last last 6 digits 34** **** **')
        ...
        for i in range(5):
                ...
                if h==lc:
                    print('googlepay unclocked successfully')
                    break
                else:
                    print('Wrong password try again')
        else:
    ...
    if r==1:
          ...
          va,li=map(int,input('ATM card valid upto for example 22/10: ').split('/'))
          ca='AvDs'
          pt=input('Enter the captcha AvDs as it is to change UPI pin number: ')
          if ca==pt:
         ...
         mr='A1D4'
         zr=input('Enter the captcha A1D4 as it is to change UPI pin number: ')
         if mr==zr:
                 g=int(input('Enter the new UPI pin number: '))
                 h=int(input('confirm the UPI pin: '))
                 if g==h:
